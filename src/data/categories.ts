...
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: 'Auto Mechanics',
    slug: 'auto-mechanics',
    description: 'Certified mechanics for repairs, maintenance, and diagnostics',
    serviceCount: 32,
    featured: true,
  },
  {
  ...
  },
  {
    ...
    name: 'Design & UI/UX',
    slug: 'design-uiux',
    description: 'Professional designers for branding, web, and mobile projects',
    serviceCount: 56,
    featured: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Licensed plumbers and electricians for repairs and installations',
    serviceCount: 41,
    featured: true,
  },
  {
  ...
  },
  {
    ...
    name: 'Photography',
    slug: 'photography',
    description: 'Professional photography for events, portraits, and commercial',
    serviceCount: 1245,
  },
  {
    id: 'food-beverages',
